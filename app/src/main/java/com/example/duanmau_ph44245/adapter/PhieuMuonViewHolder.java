...
public class PhieuMuonViewHolder extends RecyclerView.ViewHolder {
    TextView tv_name_tv, tv_name_sach, tv_tien_thue, tv_status, tv_ngay_thue, tv_ma_phieu_muon;
    ImageView img_delete_pm;
    View item_pm;
    public PhieuMuonViewHolder(@NonNull View itemView) {
        super(itemView);
        tv_ma_phieu_muon = itemView.findViewById(R.id.tv_ma_tv_frag_phieu_muon);
